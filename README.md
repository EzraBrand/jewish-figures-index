...
The published table currently has **887 deduped entries**, distributed across the following category buckets:
...
(Some entries belong to more than one bucket, so column sums slightly exceed 887.)
