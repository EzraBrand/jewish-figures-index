...
The published table currently has **848 deduped entries**, distributed across the following category buckets:
...
(Some entries belong to more than one bucket, so column sums slightly exceed 848.)
