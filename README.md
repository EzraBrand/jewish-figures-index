...
The published table currently has **846 deduped entries**, distributed across the following category buckets:
...
(Some entries belong to more than one bucket, so column sums slightly exceed 846.)
